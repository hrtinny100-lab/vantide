# Vantide Perp Broker UI Template

This template provides a quick way to set up a customized trading UI for Vantide Perpsrokers, built with Remix and deployable on Vercel.
...
1. Visit the [Vantide Perp Storybook Trading Page](https://storybook.orderly.network/?path=/story/package-trading-tradingpage--page)
...
- [Vantide Perp JS SDK Documentation](https://github.com/Vantide PerpNetwork/js-sdk)
- [Vantide Perps Documentation]
