...
export interface IPythOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getEmaPrice"
...
export interface IPythOracle extends BaseContract {
  connect(runner?: ContractRunner | null): IPythOracle;
  ...
  latestPriceInfoPublishTime: TypedContractMethod<
    [priceId: BytesLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "latestPriceInfoPublishTime"
  ): TypedContractMethod<[priceId: BytesLike], [bigint], "view">;
  getFunction(
