import{i as A,a as C,k as I,N as E,x as c,u as V,m as O,R as T,j as P,g as K,M,W as F,r as Q,e as q}from"./constants-BMPBLtAJ.js";import{r as s,n as h,c as D,U as m}from"./index-1AHWBucV.js";import"./index-DIjJpWMz.js";import{M as N}from"./index-CY6Gzoic.js";import"./index-74lgU4xS.js";import{S as i}from"./index-zodO28Qh.js";import"./index-CdRv9cz6.js";import"./index-fUXkaBea.js";import"./index-DamZVL1-.js";import"./index-DJCgIpmR.js";import"./walletConfig-6IRdRmic.js";import"./sha2-PsZP68hz.js";import"./index.es-DWy6X4lZ.js";import"./index-CJdot1dH.js";import"./to-string-CfGorqUQ.js";import"./http-DtKtQ2Cz.js";import"./index-rkm7du_E.js";import"./index-BWFiiVFd.js";import"./ref-Csg4BIxb.js";const H={numericInputKeyDown(l,e,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=l.metaKey||l.ctrlKey,t=l.key,r=t.toLocaleLowerCase(),u=r==="a",U=r==="c",W=r==="v",z=r==="x",j=t===",",L=t===".",R=t>="0"&&t<="9";!a&&(u||U||W||z)&&l.preventDefault(),e==="0"&&!j&&!L&&t==="0"&&l.preventDefault(),e==="0"&&R&&(o(t),l.preventDefault()),(j||L)&&(e||(o("0."),l.preventDefault()),(e?.includes(".")||e?.includes(","))&&l.preventDefault()),!R&&!n.includes(t)&&!L&&!j&&l.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
...
`;var B=function(l,e,o,n){var a=arguments.length,t=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,o):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(l,e,o,n);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(t=(a<3?r(t):a>3?r(e,o,t):r(e,o))||t);return a>3&&t&&Object.defineProperty(e,o,t),t};let _=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return c`
...
`;var v=function(l,e,o,n){var a=arguments.length,t=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,o):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(l,e,o,n);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(t=(a<3?r(t):a>3?r(e,o,t):r(e,o))||t);return a>3&&t&&Object.defineProperty(e,o,t),t};const J=5e-5;let x=class extends C{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",o=E.bigNumber(e).gt("0");return c`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){O.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),T.push("SwapSelectToken",{target:this.target})}onBuyToken(){T.push("OnRampProviders")}};x.styles=[Z];v([h()],x.prototype,"focused",void 0);v([h()],x.prototype,"balance",void 0);v([h()],x.prototype,"value",void 0);v([h()],x.prototype,"price",void 0);v([h()],x.prototype,"marketValue",void 0);v([h()],x.prototype,"disabled",void 0);v([h()],x.prototype,"target",void 0);v([h()],x.prototype,"token",void 0);v([h()],x.prototype,"onSetAmount",void 0);v([h()],x.prototype,"onSetMaxValue",void 0);x=v([D("w3m-swap-input")],x);const ee=A`
...
`;var w=function(l,e,o,n){var a=arguments.length,t=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,o):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(l,e,o,n);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(t=(a<3?r(t):a>3?r(e,o,t):r(e,o))||t);return a>3&&t&&Object.defineProperty(e,o,t),t};let p=class extends C{constructor(){super(),this.unsubscribe=[],this.initialParams=T.state.data?.swap,this.detailsOpen=!1,this.caipAddress=P.state.caipAddress,this.caipNetworkId=I.state.activeCaipNetwork?.caipNetworkId,this.initialized=i.state.initialized,this.loadingQuote=i.state.loadingQuote,this.loadingPrices=i.state.loadingPrices,this.loadingTransaction=i.state.loadingTransaction,this.sourceToken=i.state.sourceToken,this.sourceTokenAmount=i.state.sourceTokenAmount,this.sourceTokenPriceInUSD=i.state.sourceTokenPriceInUSD,this.toToken=i.state.toToken,this.toTokenAmount=i.state.toTokenAmount,this.toTokenPriceInUSD=i.state.toTokenPriceInUSD,this.inputError=i.state.inputError,this.fetchError=i.state.fetchError,this.onDebouncedGetSwapCalldata=K.debounce(async()=>{await i.swapTokens()},200),I.subscribeKey("activeCaipNetwork",e=>this.onCaipNetworkChange({newCaipNetwork:e,resetSwapState:!0,initializeSwapState:!1})),P.subscribeKey("caipAddress",e=>this.onCaipAddressChange({newCaipAddress:e,resetSwapState:!0,initializeSwapState:!1})),this.unsubscribe.push(I.subscribeKey("activeCaipNetwork",e=>this.onCaipNetworkChange({newCaipNetwork:e,resetSwapState:!1,initializeSwapState:!0})),P.subscribeKey("caipAddress",e=>this.onCaipAddressChange({newCaipAddress:e,resetSwapState:!1,initializeSwapState:!0})),M.subscribeKey("open",e=>{e||i.resetState()}),T.subscribeKey("view",e=>{e.includes("Swap")||i.resetValues()}),i.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.fetchError=e.fetchError}))}async firstUpdated(){i.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval)}render(){return c`
    ...
    `}templateTokenInput(e,o){const n=i.state.myTokensWithBalance?.find(u=>u?.address===o?.address),a=e==="toToken"?this.toTokenAmount:this.sourceTokenAmount,t=e==="toToken"?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,r=E.parseLocalStringToNumber(a)*t;return c`<w3m-swap-input
    ...
    </wui-flex>`}onSwitchTokens(){i.switchTokens()}async onSwapPreview(){const e=I.state.activeChain;this.fetchError&&await i.swapTokens(),O.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:this.sourceToken?.symbol||"",swapToToken:this.toToken?.symbol||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:P.state.preferredAccountTypes?.[e]===F.ACCOUNT_TYPES.SMART_ACCOUNT}}),T.push("SwapPreview")}async handleSwapParameters(){this.initialParams&&(i.state.initialized||await new Promise(o=>{const n=i.subscribeKey("initialized",a=>{a&&(n?.(),o())})}),await this.setSwapParameters(this.initialParams))}async setSwapParameters({amount:e,fromToken:o,toToken:n}){(!i.state.tokens||!i.state.myTokensWithBalance)&&await new Promise(r=>{const u=i.subscribeKey("myTokensWithBalance",U=>{U&&U.length>0&&(u?.(),r())});setTimeout(()=>{u?.(),r()},5e3)});const a=[...i.state.tokens||[],...i.state.myTokensWithBalance||[]];if(o){const t=a.find(r=>r.symbol.toLowerCase()===o.toLowerCase());t&&i.setSourceToken(t)}if(n){const t=a.find(r=>r.symbol.toLowerCase()===n.toLowerCase());t&&i.setToToken(t)}e&&!isNaN(Number(e))&&i.setSourceTokenAmount(e)}onCaipAddressChange({newCaipAddress:e,resetSwapState:o,initializeSwapState:n}){this.caipAddress!==e&&(this.caipAddress=e,o&&i.resetState(),n&&i.initializeState())}onCaipNetworkChange({newCaipNetwork:e,resetSwapState:o,initializeSwapState:n}){this.caipNetworkId!==e?.caipNetworkId&&(this.caipNetworkId=e?.caipNetworkId,o&&i.resetState(),n&&i.initializeState())}};p.styles=ee;w([h({type:Object})],p.prototype,"initialParams",void 0);w([s()],p.prototype,"interval",void 0);w([s()],p.prototype,"detailsOpen",void 0);w([s()],p.prototype,"caipAddress",void 0);w([s()],p.prototype,"caipNetworkId",void 0);w([s()],p.prototype,"initialized",void 0);w([s()],p.prototype,"loadingQuote",void 0);w([s()],p.prototype,"loadingPrices",void 0);w([s()],p.prototype,"loadingTransaction",void 0);w([s()],p.prototype,"sourceToken",void 0);w([s()],p.prototype,"sourceTokenAmount",void 0);w([s()],p.prototype,"sourceTokenPriceInUSD",void 0);w([s()],p.prototype,"toToken",void 0);w([s()],p.prototype,"toTokenAmount",void 0);w([s()],p.prototype,"toTokenPriceInUSD",void 0);w([s()],p.prototype,"inputError",void 0);w([s()],p.prototype,"fetchError",void 0);p=w([D("w3m-swap-view")],p);const te=A`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
